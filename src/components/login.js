...
function Login() {
    ...
    return (
      <section>
        ...
        <img src=".../public/imagenes/logo.png" id="Logo" alt="Logo" />
          <h2>Bienvenidos a AutoGenius</h2>
          <form onSubmit={handleSubmit}>
            
            <input type="text" id="usuario" placeholder="Usuario" value={username}
          ...
          <h3>Eres nuevo? <Link to="/registrar">Crea una cuenta</Link></h3>
        </div>
      </section>
    );
  }
